        ...
        return (
            <ScrollView contentContainerStyle={styles.scrollView}>
                ...
                <View style={styles.imageView}>
                    <Image source={User1_Icon} style={styles.profileIcon}/>
                </View>
                <View style={styles.mailEntireView}>
                    <View style={styles.mailLeftView}>
                        <Text style={styles.mailLeftText}>
                            Email Address
                        </Text>
                    </View>
                    <View style={styles.mailRightView}>
                        <Text style={styles.mailRightText} ellipsizeMode="tail" numberOfLines={1}>
                            james@highhorse.agency
                        </Text>
                    </View>
                </View>
                <View style={styles.mailEntireView}>
                    ...
                    <View style={styles.mailRightView}>
                        <TextInput style={styles.passwordRightText} secureTextEntry={true} editable={false} value="highhorse.agency">
                        </TextInput>
                    </View>
                </View>
                <View style={styles.mailEntireView}>
                    ...
                    <View style={styles.mailRightView}>
                        <Text style={styles.mailRightText}>
                            Product Director
                        </Text>
                    </View>
                </View>
