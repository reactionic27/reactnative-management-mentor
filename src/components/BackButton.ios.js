...
class BackButton extends Component {
    ...
    render() {
        ...
        Animated.timing(this.anim, {
            toValue: 1,
            duration: this.props.scene.duration
        }).start();
        ...
        return (
            ...
            <TouchableOpacity key={'leftNavBarBtn' + name}
                              ...
                              style={this.state.wideBackButton ? [styles.leftButton, {width: 300}] : styles.leftButton}
                              onPress={() => {
                ...
                <Animated.View style={[styles.iconContainer, {opacity: this.anim}]}>
                    <Image source={Back_Button} style={{width: 16, height: 16, marginTop: 10}}/>
                </Animated.View>
                <Animated.View style={[this.state.wideBackButton ? [styles.textContainer, {flex: 15}] : styles.textContainer, {
