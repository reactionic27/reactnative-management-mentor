...
var ParallaxView = React.createClass({
    ...
    renderHeader: function () {
        var {windowHeight, backgroundSource, fadeRatio} = this.props;
        var {scrollY} = this.state;
        if (!windowHeight || !backgroundSource) {
            return null;
        }
        return (
            <Animated.View style={{
                ...
                opacity: scrollY.interpolate({
                    inputRange: [-windowHeight, 0, windowHeight / fadeRatio],
                    outputRange: [1, 1, 0]
                })
            }}>
                {this.props.header}
    ...
    render: function () {
        ...
        return (
            <View style={[styles.container, style, props.scrollContainerStyle]}>
